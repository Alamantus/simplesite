...
$(document).ready(function() {
  ...
  $.getJSON('sitedata.json', function(data) {
    var htmlContent = '<div><h2>General Site Data <span id="toggleGlobalContent" class="toggle-button">collapse</span></h2>';
    ...
    htmlContent += '<div><h2>Content <span id="togglePages" class="toggle-button">collapse</span></h2><div id="pages">';
...
function buildPageEntry(index, title, text, type) {
  var result = '<div id="page' + index.toString() + '" class="content-area">';
    ...
    result += '<div id="page' + index.toString() + 'TextContainer" style="display:' + ((type !== 'link') ? 'block' : 'none') + ';">\
        ...
        <textarea id="page' + index.toString() + 'Text" class="page-text">' + text + '</textarea>\
      </div>';
